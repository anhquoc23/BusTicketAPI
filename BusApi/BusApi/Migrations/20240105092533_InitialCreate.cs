        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StationProvince = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StationStartId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    StationEndId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Routines_Stations_StationEndId",
                        column: x => x.StationEndId,
                        principalTable: "Stations",
                        principalColumn: "StationId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Routines_Stations_StationStartId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Trips_Routines_RoutineId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Routines_StationEndId",
                table: "Routines",
                column: "StationEndId");

            migrationBuilder.CreateIndex(
                name: "IX_Routines_StationStartId",
                table: "Routines",
